...
import CustomFileUpload, {Base64Map} from '@/components/forms/meta/CustomFileUpload.vue';
...
import MetaInputIntQty from '@/components/forms/meta/MetaInputIntQty.vue';
import MetaInputFloatQty from '@/components/forms/meta/MetaInputFloatQty.vue';
