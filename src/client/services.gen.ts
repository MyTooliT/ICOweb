 ...
 * @returns SupplyVoltageResponseModel Supply voltage of connected STH.
 * @throws ApiError
 */
export const getSupplyVoltageApiV1SthSupplyVoltageGet = (): CancelablePromise<GetSupplyVoltageApiV1SthSupplyVoltageGetResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/api/v1/sth/supply-voltage',
    errors: {
        500: 'Failed to read supply voltage.'
    }
}); };
 ...
 * @throws ApiError
 */
export const executeMeasurementApiV1MeasurementExecutePost = (data: ExecuteMeasurementApiV1MeasurementExecutePostData): CancelablePromise<ExecuteMeasurementApiV1MeasurementExecutePostResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/api/v1/measurement/execute',
    body: data.requestBody,
    mediaType: 'application/json',
    errors: {
        422: 'Validation Error'
