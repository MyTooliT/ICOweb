...
/**
 * Pydantic wrapper for ADCConfiguration
 */
export type ADCConfigurationModel = {
    prescaler: number;
...
export type MeasurementInstructions_Input = {
    ...
    adc: ADCConfigurationModel | null;
    meta: Metadata | null;
...
/**
 * Pydantic wrapper for SensorNodeAttributes
 */
export type SensorNodeAttributesModel = {
    name: string;
    mac_address: string;
    adc_configuration: ADCConfigurationModel;
};
...
export type SystemStateModel = {
    state: State;
    disk_capacity: DiskCapacity | null;
    measurement_status: MeasurementStatus | null;
    cloud_status: boolean;
    connected_node_information: SensorNodeAttributesModel | null;
};
...
export type ReadAdcApiV1SthReadAdcGetResponse = ADCConfigurationModel;

export type WriteAdcApiV1SthWriteAdcPutData = {
    requestBody: ADCConfigurationModel;
};
